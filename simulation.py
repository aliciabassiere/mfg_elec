...
plt.bar(2018+out['time'],out['Default peak'], width=0.25,
        bottom=out['Renewable peak supply']+out['Baseload peak supply']+out['Gas peak supply']+out['Coal peak supply'], label='outage', color ='black')
...
plt.bar(2018+out['time'],out['Default offpeak'],width=0.25,
        bottom=out['Renewable offpeak supply']+out['Baseload offpeak supply']+out['Gas offpeak supply']+out['Coal offpeak supply'],label='Outage', color ='black')
