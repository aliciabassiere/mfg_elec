{
    ...
    "discount rate" : 0.08, # Common discount rate for the planner problem
    "Nfuels" : 1, # Number of different fuels
    "Fsupply" : ([20], [0.5]), # Fuel supply functions; they are linear in this version of the model;
    # the first array contains the intercepts and the second one the coefficients
    "demand" : [20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20],
    #"demand" : [61.23322924, 55.99534092, 55.48594115, 60.34034567, 61.0531315 , 55.83064873, 55.3227472 , 60.16287406, 60.38244757, 55.21733508,  54.71501297]
